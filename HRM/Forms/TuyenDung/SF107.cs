...
{
    public partial class SF107 : GridBaseForm
    {
        #region ---- Variables ----
        ...
        protected override void GetNewData()
        {
            ...
            //{
            //    UICommon.ShowMsgInfo("MSG025", lblQuy.Text, cboQuy.SelectedValue.ToString());
            //    return;
            //}
            ...
            frm.Nam = CommonUtil.IsInt(txtNam.Text.ToString());
        ...
        {
            List<TD_UngVien> list = _bussUngVien.GetDataByPhongBanQuyNam(((DM_PhongBan)this.cboPhongBan.SelectedItem).Id, CommonUtil.IsInt(this.cboQuy.Text), CommonUtil.IsInt(txtNam.Text));
