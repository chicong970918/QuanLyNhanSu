...
{
    public partial class SF309 : BaseForm
    {
        #region ---- Variables ----
        ...
        {
            InitializeComponent();
            this.Load += new EventHandler(SF309_Load);
        }
        ...
        void SF309_Load(object sender, EventArgs e)
        {
            _bangLuong=BangLuong;
            txtHoDem.Text = _bangLuong.HoDem;
            txtMaNhanVien.Text = _bangLuong.MaNhanVien;
            txtTen.Text = _bangLuong.Ten;
            txtSoTien.Text = _bangLuong.PhuCapKhac.HasValue ? _bangLuong.PhuCapKhac.Value.ToString() : "0";
            _SoTien = _bangLuong.PhuCapKhac.HasValue ? _bangLuong.PhuCapKhac.Value :0;
            txtSoTien.Focus();
        } 
