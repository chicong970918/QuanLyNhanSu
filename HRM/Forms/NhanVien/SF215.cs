...
{
    public partial class SF215 : TuyenDungBaseForm
    {
       #region ---- Variables ----
        ...
        {
            InitializeComponent();
            this.Load += new EventHandler(SF215_Load);
        ...
        {
            if (_bussHopDong.CheckedKetThucHDThoiViec(_IdNhanVien))
            {
                UICommon.ShowMsgInfo("MSG050");
                return ;
            }

            if (_bussHopDong.CheckedKetThucHDChinhThuc(_IdNhanVien))
            {
                UICommon.ShowMsgInfo("MSG051");
                return;
            }
            Enable(true);
            ...
            if (Validator() == true)
            {
                if (brscGrdData.Count > 0)
                {
                    ...
                    List<NV_HopDong> list = (List<NV_HopDong>)brscGrdData.DataSource;
                     _bussHopDong.UpdateDataList(list);
        ...
        private void InitForm()
        {
            ...
            // Get data
            this.brscGrdData.DataSource = _bussHopDong.GetHopDongByIdNhanVien(_IdNhanVien,2);
        ...
        private bool Validator()
        {
            ...
            foreach (NV_HopDong item in listData)
            {
                ...
                if (item.NgayKy.Value < CacheData.Context.GetSystemDate().Date  && item.Id==0)
                {
        ...
        /// <summary>
        /// Handles the Load event of the SF215 control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="System.EventArgs"/> instance containing the event data.</param>
        void SF215_Load(object sender, EventArgs e)
        {
        ...
        private void  btnPrintTemplate_Click(object sender, EventArgs e)
        {
            ...
            if (hopDong != null)
            {
                word.ExportHopDongLaoDong(hopDong);
            }
        }
