...
{
    public partial class SF204 : GridBaseForm
    {
        #region ---- Variables ----
        ...
        {
            brscGrdData.DataSource = _bussNhanVien.LoadNhanVienTheoPhongBanHopDongThuViec((int)treeInfo.SelectedNode.Tag);
        ...
        private void hợpĐồngThửViệcToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (nhanvien != null)
            {
                SF214 frmHopDongThuViec = new  SF214();
                frmHopDongThuViec.IdNhanVien = nhanvien.Id;
                frmHopDongThuViec.ShowDialog();
            }
        }
