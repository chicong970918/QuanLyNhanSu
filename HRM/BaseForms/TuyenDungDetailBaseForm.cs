...
{
    public partial class TuyenDungDetailBaseForm : BaseForm
    {
         #region ---- Contructors ----
        ...
        /// </summary>
        public TuyenDungDetailBaseForm()
        {
            InitializeComponent();
            InitFormBse();
        } 
        ...
        protected virtual bool AllowDeleteData()
        {
            if (brscGrdData.Current == null)
                return false;

            if (CacheData.IsKeyUsing(this.Name, brscGrdData.Current)) //typeof(T).Name
            {
                return false;
            }
